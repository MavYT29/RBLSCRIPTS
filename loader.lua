...
local function loadPvp()
    loadRemoteScript("https://raw.githubusercontent.com/MavYT29/RBLSCRIPTS/main/brm5-pvp/main.lua")
end

local function loadPve()
    loadRemoteScript("https://raw.githubusercontent.com/MavYT29/RBLSCRIPTS/main/brm5-pve/main.lua")
end
